    ...
    <header class="w-full  bg-black text-white p-4">
            <nav class="flex justify-between ">
                ...
                <div class="w-[70%] flex justify-around font-bold">
                    <button class="bg-orange-600 p-2 rounded-lg  hover:bg-white hover:border-orange-600 hover:border-2 hover:text-black transition duration-[0.5s] "><a  href="list_absences.html">list d'absences</a></button>
                     <button class="bg-orange-600 p-2 rounded-lg  hover:bg-white hover:border-orange-600 hover:border-2 hover:text-black transition duration-[0.5s] "><a href="../prof.html">Log Out</a></button>
                </div>
        </nav>
    </header>
